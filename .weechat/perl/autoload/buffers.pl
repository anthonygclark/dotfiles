...
my %default_options = (
    ...
    "show_number"               => ["off", "display channel number (default: on)"],
    ...
    "color_current"             => ["white,bg", "color for current buffer (default: lightcyan,red)"],
    "color_default"             => ["bg", "default color for buffer name (default: default)"],
